...
- [2. Download an appropriate firmware](#2-download-an-appropriate-firmware)
  - [2.1. `generic-ext4-combined-efi.img.gz`](#21-generic-ext4-combined-efiimggz)
  - [2.2. `generic-ext4-combined.img.gz`](#22-generic-ext4-combinedimggz)
  - [2.3. `generic-ext4-rootfs.img.gz`](#23-generic-ext4-rootfsimggz)
  - [2.4. `generic-squashfs-combined-efi.img.gz`](#24-generic-squashfs-combined-efiimggz)
  - [2.5. `generic-squashfs-combined.img.gz`](#25-generic-squashfs-combinedimggz)
  - [2.6. `generic-squashfs-rootfs.img.gz`](#26-generic-squashfs-rootfsimggz)
  - [2.7. `rootfs.tar.gz`](#27-rootfstargz)
  - [2.8. summary](#28-summary)
- [3. ext4 and SquashFS image types](#3-ext4-and-squashfs-image-types)
  - [3.1. SquashFS Image](#31-squashfs-image)
    - [3.1.1. How it works in OpenWrt](#311-how-it-works-in-openwrt)
    - [3.1.2. Advantages of SquashFS](#312-advantages-of-squashfs)
    - [3.1.3. Disadvantages of SquashFS](#313-disadvantages-of-squashfs)
  - [3.2. ext4 Image](#32-ext4-image)
    - [3.2.1. How it works in OpenWrt](#321-how-it-works-in-openwrt)
    - [3.2.2. Advantages of ext4](#322-advantages-of-ext4)
    - [3.2.3. Disadvantages of ext4](#323-disadvantages-of-ext4)
  - [3.3. Summary](#33-summary)
  - [3.4. Terminology](#34-terminology)
    - [3.4.1. JFFS2 / UBIFS](#341-jffs2--ubifs)
    - [3.4.2. NOR / NAND flash](#342-nor--nand-flash)
...
## 2. Download an appropriate firmware

> OpenWrt Downloads page [https://downloads.openwrt.org/](https://downloads.openwrt.org/)

There are many kinds of firmware, let's take x86_64 target as example, here is the firmware list:
...
### 2.1. `generic-ext4-combined-efi.img.gz`
...
### 2.2. `generic-ext4-combined.img.gz`
...
### 2.3. `generic-ext4-rootfs.img.gz`
...
### 2.4. `generic-squashfs-combined-efi.img.gz`
...
### 2.5. `generic-squashfs-combined.img.gz`
...
### 2.6. `generic-squashfs-rootfs.img.gz`
...
## 3. ext4 and SquashFS image types
...
#### 3.1.3. Disadvantages of SquashFS
