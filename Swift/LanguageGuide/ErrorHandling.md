...
![do-catch.png](../../media/Swift/swift.org/do-catch.png)
...
In the above example, the `buyFavoriteSnack(person:vendingMachine:)` function is called in a `try` expression, because it can throw an error.
