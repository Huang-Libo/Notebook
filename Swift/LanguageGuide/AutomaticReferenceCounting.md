...
In addition to these two simple properties, the `HTMLElement` class defines a `lazy` property called `asHTML`. This property references a closure that combines `name` and `text` into an HTML string fragment. The `asHTML` property is of type `() -> String`.
...
![closureReferenceCycle01_2x.png](../../media/Swift/swift.org/AutomaticReferenceCounting/closureReferenceCycle01_2x.png)
...
![closureReferenceCycle02_2x.png](../../media/Swift/swift.org/AutomaticReferenceCounting/closureReferenceCycle02_2x.png)
