...
- [5. RSA 公钥算法 FAQ](#5-rsa-公钥算法-faq)
  - [5.1. RSA 算法用到的数论理论](#51-rsa-算法用到的数论理论)
  - [5.2. RSA 的缺陷](#52-rsa-的缺陷)
  - [5.3. 如果 rsa 算法中组成 n 的 p 和 q 泄漏了，敌手如何算出私钥 d ？](#53-如果-rsa-算法中组成-n-的-p-和-q-泄漏了敌手如何算出私钥-d-)
    - [5.3.1. 问题分析](#531-问题分析)
    - [5.3.2. 计算过程](#532-计算过程)
    - [5.3.3. 示例](#533-示例)
    - [5.3.4. 为什么 p 和 q 的泄露如此致命？](#534-为什么-p-和-q-的泄露如此致命)
    - [5.3.5. 如何防止p和q泄露？](#535-如何防止p和q泄露)
...
### 5.3. 如果 rsa 算法中组成 n 的 p 和 q 泄漏了，敌手如何算出私钥 d ？
