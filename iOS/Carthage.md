# Carthage<!-- omit in toc -->

Carthage builds your dependencies and provides you with **binary frameworks**, but you retain full control over your project structure and setup. Carthage *does not* automatically modify your project files or your build settings.

- [1. Quick Start](#1-quick-start)
- [2. Adding frameworks to an application](#2-adding-frameworks-to-an-application)
  - [2.1. Getting started](#21-getting-started)
    - [2.1.1. Building platform-independent XCFrameworks (Xcode 12 and above)](#211-building-platform-independent-xcframeworks-xcode-12-and-above)
      - [2.1.1.1. Migrating a project from framework bundles to XCFrameworks](#2111-migrating-a-project-from-framework-bundles-to-xcframeworks)
    - [2.1.2. Building platform-specific framework bundles (default for Xcode 11 and below)](#212-building-platform-specific-framework-bundles-default-for-xcode-11-and-below)
    - [2.1.3. For all platforms](#213-for-all-platforms)
    - [2.1.4. (Optionally) Add build phase to warn about outdated dependencies](#214-optionally-add-build-phase-to-warn-about-outdated-dependencies)
    - [2.1.5. Swift binary framework download compatibility](#215-swift-binary-framework-download-compatibility)
  - [2.2. Running a project that uses Carthage](#22-running-a-project-that-uses-carthage)
  - [2.3. Adding frameworks to unit tests or a framework](#23-adding-frameworks-to-unit-tests-or-a-framework)
  - [2.4. Upgrading frameworks](#24-upgrading-frameworks)
    - [2.4.1. Experimental Resolver](#241-experimental-resolver)
  - [2.5. Nested dependencies](#25-nested-dependencies)
  - [2.6. Using submodules for dependencies](#26-using-submodules-for-dependencies)
  - [2.7. Automatically rebuilding dependencies](#27-automatically-rebuilding-dependencies)
  - [2.8. Caching builds](#28-caching-builds)
- [3. Supporting Carthage for your framework](#3-supporting-carthage-for-your-framework)
  - [3.1. Share your Xcode schemes](#31-share-your-xcode-schemes)
  - [3.2. Resolve build failures](#32-resolve-build-failures)
  - [3.3. Tag stable releases](#33-tag-stable-releases)
  - [3.4. Archive prebuilt frameworks into zip files](#34-archive-prebuilt-frameworks-into-zip-files)
    - [3.4.1. Use travis-ci to upload your tagged prebuilt frameworks](#341-use-travis-ci-to-upload-your-tagged-prebuilt-frameworks)
  - [3.5. Build static frameworks to speed up your app’s launch times](#35-build-static-frameworks-to-speed-up-your-apps-launch-times)
    - [3.5.1. Carthage 0.30.0 or higher](#351-carthage-0300-or-higher)
    - [3.5.2. Carthage 0.29.0 or lower](#352-carthage-0290-or-lower)
  - [3.6. Declare your compatibility](#36-declare-your-compatibility)
- [4. Build static frameworks to speed up your app’s launch times](#4-build-static-frameworks-to-speed-up-your-apps-launch-times)
  - [4.1. Linking many static frameworks into your application binary](#41-linking-many-static-frameworks-into-your-application-binary)
  - [4.2. Merging your static frameworks into a single larger dynamic framework](#42-merging-your-static-frameworks-into-a-single-larger-dynamic-framework)
    - [4.2.1. Resolving linker warnings](#421-resolving-linker-warnings)
  - [4.3. Linker flags](#43-linker-flags)
  - [4.4. Embedded resources](#44-embedded-resources)
- [5. Artifacts](#5-artifacts)
  - [5.1. Cartfile](#51-cartfile)
    - [5.1.1. Origin](#511-origin)
      - [5.1.1.1. GitHub Repositories](#5111-github-repositories)
      - [5.1.1.2. Git repositories](#5112-git-repositories)
      - [5.1.1.3. Binary only frameworks](#5113-binary-only-frameworks)
    - [5.1.2. Version requirement](#512-version-requirement)
    - [5.1.3. Example Cartfile](#513-example-cartfile)
  - [5.2. Cartfile.private](#52-cartfileprivate)
  - [5.3. Cartfile.resolved](#53-cartfileresolved)
  - [5.4. Carthage/Build](#54-carthagebuild)
  - [5.5. Carthage/Checkouts](#55-carthagecheckouts)
    - [5.5.1. With submodules](#551-with-submodules)
  - [5.6. ~/Library/Caches/org.carthage.CarthageKit](#56-librarycachesorgcarthagecarthagekit)
  - [5.7. Binary Project Specification](#57-binary-project-specification)
    - [5.7.1. Publish an XCFramework build alongside the framework build using an `alt=` query parameter](#571-publish-an-xcframework-build-alongside-the-framework-build-using-an-alt-query-parameter)
    - [5.7.2. Example binary project specification](#572-example-binary-project-specification)
  - [5.8. Version Files](#58-version-files)
    - [5.8.1. File location and format](#581-file-location-and-format)
    - [5.8.2. Caching builds with version files](#582-caching-builds-with-version-files)
- [6. CarthageKit](#6-carthagekit)
- [7. Differences between Carthage and CocoaPods](#7-differences-between-carthage-and-cocoapods)
- [8. Known issues](#8-known-issues)
  - [8.1. DWARFs symbol problem](#81-dwarfs-symbol-problem)
  - [8.2. Using Carthage with Xcode 12/13](#82-using-carthage-with-xcode-1213)
    - [8.2.1. Scenario](#821-scenario)
    - [8.2.2. Why Carthage compilation fails](#822-why-carthage-compilation-fails)
    - [8.2.3. Workaround](#823-workaround)
    - [8.2.4. How to make it work](#824-how-to-make-it-work)
    - [8.2.5. `carthage.sh`'s artifacts](#825-carthageshs-artifacts)
    - [8.2.6. Better solution: Use xcframeworks](#826-better-solution-use-xcframeworks)
...
## 2. Adding frameworks to an application
...
#### 2.1.1. Building platform-independent XCFrameworks (Xcode 12 and above)
...
##### 2.1.1.1. Migrating a project from framework bundles to XCFrameworks
...
#### 2.1.2. Building platform-specific framework bundles (default for Xcode 11 and below)

[omit]

#### 2.1.3. For all platforms
...
#### 2.1.4. (Optionally) Add build phase to warn about outdated dependencies
...
#### 2.1.5. Swift binary framework download compatibility
...
### 2.2. Running a project that uses Carthage
...
### 2.3. Adding frameworks to unit tests or a framework
...
### 2.6. Using submodules for dependencies
...
### 2.7. Automatically rebuilding dependencies
...
## 3. Supporting Carthage for your framework
...
### 3.4. Archive prebuilt frameworks into zip files
...
#### 3.4.1. Use travis-ci to upload your tagged prebuilt frameworks
...
### 3.5. Build static frameworks to speed up your app’s launch times
...
#### 3.5.1. Carthage 0.30.0 or higher
...
#### 3.5.2. Carthage 0.29.0 or lower
...
### 3.6. Declare your compatibility
...
## 4. Build static frameworks to speed up your app’s launch times
...
### 4.1. Linking many static frameworks into your application binary
...
### 4.2. Merging your static frameworks into a single larger dynamic framework
...
#### 4.2.1. Resolving linker warnings
...
##### 5.1.1.3. Binary only frameworks
...
### 5.6. ~/Library/Caches/org.carthage.CarthageKit
...
### 5.7. Binary Project Specification
...
#### 5.7.1. Publish an XCFramework build alongside the framework build using an `alt=` query parameter
...
#### 5.7.2. Example binary project specification
...
#### 5.8.1. File location and format
...
#### 5.8.2. Caching builds with version files
...
## 7. Differences between Carthage and CocoaPods
...
### 8.2. Using Carthage with Xcode 12/13
...
#### 8.2.2. Why Carthage compilation fails
...
1. place this script somewhere to your `PATH` (I personally have it in `/usr/local/bin/carthage.sh`)
    ...
    `carthage.sh` ([#3201, Update for Xcode 13](https://github.com/Carthage/Carthage/issues/3201)):
...
#### 8.2.6. Better solution: Use xcframeworks
